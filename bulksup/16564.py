...
number_character, remain_level = map(int, input().split())
character_group = []
for i in range(number_character):
    character_group.append(int(input()))
character_group.sort()

start = character_group[0]
end = character_group[-1]+remain_level
